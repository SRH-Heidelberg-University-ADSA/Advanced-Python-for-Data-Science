...
| 2 | Concurrency & Asynchronous Workflows | ✅ | ✅ |
| 3 | GPU Programming & Performance| ✅ | ✅ |
...
├── SUBMISSION_INSTRUCTIONS.md         ← Lab take-home submission guide
├── PYTHON_ENVIRONMENT_SETUP.md        ← Environment installation guide
│
├── Week1/                             ← Advanced Python Programming
│   ├── Lecture/
│   │
│   └── Lab-Hands-On/
│
├── Week2/                             ← Concurrency & Asynchronous Workflow
│   ├── Lecture/
│   │
│   └── Lab-Hands-On/
│
├── Week3/                             ← GPU Programming & Performance
│   ├── Lecture/
│   │
│   └── Lab-Hands-On/
│
├── Week4/                             ← Software Design & Testing
│   ├── Lecture/
│   │
│   └── Lab-Hands-On/
│
├── Week5/                             ← Web Development & API Design
│   ├── Lecture/
│   │
│   └── Lab-Hands-On/
│
├── Week6/                             ← Cloud Deployment & DevOps
│   ├── Lecture/
│   │
│   └── Lab-Hands-On/
│
└── Week7/                             ← Integrated System Design
    ├── Lecture/
    │
    └── Lab-Hands-On/
```
...
> You may skip these instructions if you already did them in the Python Foundations for Data Science Module.
Before Week 1, ensure the following are installed on your machine:

| Tool | Purpose | Install Link |
|------|---------|--------------|
| Python 3.10+ | Core language | [python.org](https://www.python.org/downloads/) |
| Anaconda / Miniconda | Environment & package manager | [anaconda.com](https://www.anaconda.com/download) |
| Jupyter Notebook / JupyterLab | Interactive coding environment | Included with Anaconda |
